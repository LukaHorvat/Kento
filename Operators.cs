...
namespace Kento
{
	...
	{
		private static Dictionary<string, System.Type> operatorDictionary;

		private static Dictionary<System.Type, string> representationDictionary;

		private static LinkedList<BracketType> brackets;
	...
	internal class InvokeOperator : Operator
	{
		...
		public override Value Operate(Value First, Value Second)
		{
			...
			{
				Value toReturn = (First as IFunction).Invoke((Second.Clone() as Array));
				return toReturn;
			}
	...
	internal class SufixIncrement : Operator
	{
	...
	internal class SufixDecrement : Operator
	{
	...
	internal class PrefixIncrement : Operator
	{
	...
	internal class PrefixDecrement : Operator
	{
